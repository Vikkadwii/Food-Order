...
public class Login_View extends javax.swing.JFrame {
    ...
    public void btnCustomer(ActionListener Button){
        jButton1.addActionListener(Button);
    }
    
    public void btnAdmin(ActionListener Button){
        jButton2.addActionListener(Button);
    }
    
    public void btnKurir(ActionListener Button){
        jButton3.addActionListener(Button);
    }
    
    public void btnRestaurant(ActionListener Button){
